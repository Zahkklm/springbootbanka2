INSERT INTO online_bank.account (id, sort_code, account_number, current_balance, bank_name, owner_name, credit_amount)
VALUES (1, '53-68-92', '73084635', 1071.78, 'Challenger Bank', 'Paul Dragoslav', 0.0);
INSERT INTO online_bank.account (id, sort_code, account_number, current_balance, bank_name, owner_name, credit_amount)
VALUES (2, '65-93-37', '21956204', 67051.01, 'High Street Bank', 'Scrooge McDuck', 0.0);
